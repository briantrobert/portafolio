...
export default function Home() {
  return (
    <>
      {/* navbar section */}
      <nav className="flex justify-between bg-white backdrop-blur-lg py-2">
      ...
      <div className="flex h-screen w-full">
        <div className="flex w-full h-full lg:w-1/2 items-center justify-center">
          <div className="p-5 rounded-lg m-6">
            <h1 className="font-bold text-4xl">I'm a web developer</h1>
