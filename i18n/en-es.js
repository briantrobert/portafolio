export const allEnglish = {
   ...
   navButton:[
    ...
    heroButton:"About..",
    interest:"About me",
    portFolioSecc:"Proyects",
    buttonSee:"See more",      
    skillsectionName:"Skills",      
    tools: "Tools",
    cardContactText:"Skills",
    contancName:"Hello my name is ",
    cardContactText:`I am a graduate of Computer Engineering at the
    ...
    message:"Message",
    placeholderMessage:"Some text",
    buttomSend:"Send",
    footerFallow:"Fallow me",
    resources:"Resources"            
}

export const allSpanish = {
    title1 : "Hola",
    title2 : "Mundo",
    navButton:[
        "Inicio",
    ...
    heroButton:"Acerca de mi",
    interest:"Acerca de mi",
    portFolioSecc:"Proyectos",
    buttonSee:"Ver más",         
    skillsectionName:"Habilidades",
    tools: "Herramientas",
    contancName:"Hola mi nombre es ",         
    cardContactText:`Soy graduado de Ingeniería Informática en la
    ...
    message:"Mensaje",
    placeholderMessage:"Mensaje a enviar",
    buttomSend:"Enviar",
    footerFallow:"Sígueme",
    resources:"Recursos"                 
}