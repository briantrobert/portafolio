...
export const dataProyectEn = [
      {
            id: 1,
            imgUrl: "/img/landing.png",
            simple:`Project carried out to develop knowledge about,
                     handling forms from the most basic such as login
                     even the most complex...`,
            resume: `Project carried out to develop knowledge about,
                     handling forms from the most basic such as login
                     even the most complex ones taking into account the types of fields
                     as for examples of type select, checkbox time, datetime etc.
                     Libraries such as React Hook Form were used to manage
                     the forms and the YUP library for validations.`,
            tUsedText:"Tech used",
            techUsed: [<HtmlSvg itsMini/>,<CssSvg itsMini/>,<JavaScriptSvg itsMini/>],
            codeLink :"",
            hostedLink:"",
